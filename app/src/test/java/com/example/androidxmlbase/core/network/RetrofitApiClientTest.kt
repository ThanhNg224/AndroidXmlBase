...
class RetrofitApiClientTest {
    ...
    @Test
    fun `200 with valid JSON body maps to Success`() = runTest {
    ...
    @Test
    fun `404 maps to HttpError with the response code`() = runTest {
    ...
    @Test
    fun `500 maps to HttpError with the response code`() = runTest {
    ...
    @Test
    fun `204 No Content maps to EmptyBody`() = runTest {
    ...
    @Test
    fun `malformed JSON body maps to ParseError`() = runTest {
    ...
    @Test
    fun `unreachable server maps to NetworkError`() = runTest {
