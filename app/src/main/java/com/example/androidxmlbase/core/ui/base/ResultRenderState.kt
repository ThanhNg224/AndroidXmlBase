...
fun <T> ResultState<T>.toRenderState(): ResultRenderState = when (this) {
    is ResultState.Loading -> ResultRenderState(
        isLoadingVisible = true,
        isContentVisible = false,
        isErrorVisible = false,
        errorMessage = null,
    )
    is ResultState.Success -> ResultRenderState(
        isLoadingVisible = false,
        isContentVisible = true,
        isErrorVisible = false,
        errorMessage = null,
    )
    is ResultState.Error -> ResultRenderState(
        isLoadingVisible = false,
        isContentVisible = false,
        isErrorVisible = true,
 ...
 */
fun ResultRenderState.applyVisibilityTo(loadingView: View, contentView: View, errorView: View) {
